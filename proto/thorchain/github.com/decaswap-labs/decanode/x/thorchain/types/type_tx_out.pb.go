...
type TxOutItem struct {
	Chain                 github_com_decaswap_labs_decanode_common.Chain   `protobuf:"bytes,1,opt,name=chain,proto3,casttype=github.com/decaswap-labs/decanode/common.Chain" json:"chain"`
	ToAddress             github_com_decaswap_labs_decanode_common.Address `protobuf:"bytes,2,opt,name=to_address,json=toAddress,proto3,casttype=github.com/decaswap-labs/decanode/common.Address" json:"to_address"`
	VaultPubKey           github_com_decaswap_labs_decanode_common.PubKey  `protobuf:"bytes,3,opt,name=vault_pub_key,json=vaultPubKey,proto3,casttype=github.com/decaswap-labs/decanode/common.PubKey" json:"vault_pub_key,omitempty"`
	...
	InHash                github_com_decaswap_labs_decanode_common.TxID    `protobuf:"bytes,8,opt,name=in_hash,json=inHash,proto3,casttype=github.com/decaswap-labs/decanode/common.TxID" json:"in_hash,omitempty"`
	OutHash               github_com_decaswap_labs_decanode_common.TxID    `protobuf:"bytes,9,opt,name=out_hash,json=outHash,proto3,casttype=github.com/decaswap-labs/decanode/common.TxID" json:"out_hash,omitempty"`
	...
	VaultPubKeyEddsa      github_com_decaswap_labs_decanode_common.PubKey  `protobuf:"bytes,15,opt,name=vault_pub_key_eddsa,json=vaultPubKeyEddsa,proto3,casttype=github.com/decaswap-labs/decanode/common.PubKey" json:"vault_pub_key_eddsa,omitempty"`
}
...
var fileDescriptor_94b7695443313e72 = []byte{
	...
	,
}
...
func (m *TxOutItem) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.ToAddress = github_com_decaswap_labs_decanode_common.Address(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.VaultPubKey = github_com_decaswap_labs_decanode_common.PubKey(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
		...
		case 8:
			...
			m.InHash = github_com_decaswap_labs_decanode_common.TxID(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 9:
			if wireType != 2 {
			...
			m.OutHash = github_com_decaswap_labs_decanode_common.TxID(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
		...
		case 15:
			...
			m.VaultPubKeyEddsa = github_com_decaswap_labs_decanode_common.PubKey(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 16:
			if wireType != 2 {
