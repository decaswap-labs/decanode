...
const (
	...
	Query_DecaPool_FullMethodName               = "/types.Query/DecaPool"
	Query_DecaProvider_FullMethodName           = "/types.Query/DecaProvider"
	Query_DecaProviders_FullMethodName          = "/types.Query/DecaProviders"
...
func (c *queryClient) DecaPool(ctx context.Context, in *QueryDecaPoolRequest, opts ...grpc.CallOption) (*QueryDecaPoolResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_DecaPool_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) DecaProvider(ctx context.Context, in *QueryDecaProviderRequest, opts ...grpc.CallOption) (*QueryDecaProviderResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_DecaProvider_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) DecaProviders(ctx context.Context, in *QueryDecaProvidersRequest, opts ...grpc.CallOption) (*QueryDecaProvidersResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_DecaProviders_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) QuoteLimit(ctx context.Context, in *QueryQuoteLimitRequest, opts ...grpc.CallOption) (*QueryQuoteLimitResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_QuoteLimit_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) SwapDetails(ctx context.Context, in *QuerySwapDetailsRequest, opts ...grpc.CallOption) (*QuerySwapDetailsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_SwapDetails_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) DecaPool(context.Context, *QueryDecaPoolRequest) (*QueryDecaPoolResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DecaPool not implemented")
}
func (UnimplementedQueryServer) DecaProvider(context.Context, *QueryDecaProviderRequest) (*QueryDecaProviderResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DecaProvider not implemented")
}
func (UnimplementedQueryServer) DecaProviders(context.Context, *QueryDecaProvidersRequest) (*QueryDecaProvidersResponse, error) {
...
func _Query_DecaPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_DecaPool_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_DecaProvider_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_DecaProvider_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_DecaProviders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_DecaProviders_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
