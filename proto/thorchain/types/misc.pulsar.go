...
var (
	md_ProtoString       protoreflect.MessageDescriptor
	fd_ProtoString_value protoreflect.FieldDescriptor
)

func init() {
	file_types_misc_proto_init()
	md_ProtoString = File_types_misc_proto.Messages().ByName("ProtoString")
	fd_ProtoString_value = md_ProtoString.Fields().ByName("value")
}

var _ protoreflect.Message = (*fastReflection_ProtoString)(nil)

type fastReflection_ProtoString ProtoString

func (x *ProtoString) ProtoReflect() protoreflect.Message {
	return (*fastReflection_ProtoString)(x)
}

func (x *ProtoString) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_ProtoString_messageType fastReflection_ProtoString_messageType
var _ protoreflect.MessageType = fastReflection_ProtoString_messageType{}

type fastReflection_ProtoString_messageType struct{}

func (x fastReflection_ProtoString_messageType) Zero() protoreflect.Message {
	return (*fastReflection_ProtoString)(nil)
}
func (x fastReflection_ProtoString_messageType) New() protoreflect.Message {
	return new(fastReflection_ProtoString)
}
func (x fastReflection_ProtoString_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_ProtoString
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_ProtoString) Descriptor() protoreflect.MessageDescriptor {
	return md_ProtoString
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_ProtoString) Type() protoreflect.MessageType {
	return _fastReflection_ProtoString_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_ProtoString) New() protoreflect.Message {
	return new(fastReflection_ProtoString)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_ProtoString) Interface() protoreflect.ProtoMessage {
	return (*ProtoString)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_ProtoString) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Value != "" {
		value := protoreflect.ValueOfString(x.Value)
		if !f(fd_ProtoString_value, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_ProtoString) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "types.ProtoString.value":
		return x.Value != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: types.ProtoString"))
		}
		panic(fmt.Errorf("message types.ProtoString does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ProtoString) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "types.ProtoString.value":
		x.Value = ""
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_ProtoString) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "types.ProtoString.value":
		value := x.Value
	...
	default:
		...
		panic(fmt.Errorf("message types.ProtoString does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ProtoString) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "types.ProtoString.value":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ProtoString) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "types.ProtoString.value":
		panic(fmt.Errorf("field value of message types.ProtoString is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: types.ProtoString"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_ProtoString) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "types.ProtoString.value":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_ProtoString) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in types.ProtoString", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_ProtoString) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ProtoString) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_ProtoString) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_ProtoString) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*ProtoString)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ProtoString: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ProtoString: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func (x *ProtoBools) slowProtoReflect() protoreflect.Message {
	mi := &file_types_misc_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (*ProtoBools) Descriptor() ([]byte, []int) {
	return file_types_misc_proto_rawDescGZIP(), []int{6}
}
...
var file_types_misc_proto_rawDesc = []byte{
	...
	,
...
var file_types_misc_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_types_misc_proto_goTypes = []interface{}{
	...
	(*ProtoString)(nil),       // 4: types.ProtoString
	(*ProtoStrings)(nil),      // 5: types.ProtoStrings
	(*ProtoBools)(nil),        // 6: types.ProtoBools
}
...
func file_types_misc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_types_misc_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
