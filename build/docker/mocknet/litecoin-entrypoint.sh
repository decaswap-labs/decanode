...
litecoind -regtest -rpcport="$RPC_PORT" -txindex -rpcuser="$SIGNER_NAME" -rpcpassword="$SIGNER_PASSWD" -rpcallowip=0.0.0.0/0 -rpcbind=127.0.0.1 -rpcbind="$(hostname)" -vbparams=mweb:9999999999:9999999999 &
