...
type MsgOutboundTx struct {
	...
	InTxID gitlab_com_thorchain_thornode_v3_common.TxID  `protobuf:"bytes,2,opt,name=in_tx_id,json=inTxId,proto3,casttype=github.com/decaswap-labs/decanode/common.TxID" json:"in_tx_id,omitempty"`
