...
type MsgObservedTxOut struct {
	Txs    gitlab_com_thorchain_thornode_v3_common.ObservedTxs `protobuf:"bytes,1,rep,name=txs,proto3,castrepeated=github.com/decaswap-labs/decanode/common.ObservedTxs" json:"txs"`
