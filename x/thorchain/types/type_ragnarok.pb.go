...
type RagnarokWithdrawPosition struct {
	...
	Pool   gitlab_com_thorchain_thornode_v3_common.Asset `protobuf:"bytes,2,opt,name=pool,proto3,customtype=github.com/decaswap-labs/decanode/common.Asset" json:"pool"`
}
