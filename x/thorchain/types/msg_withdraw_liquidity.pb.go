...
type MsgWithdrawLiquidity struct {
	...
	WithdrawAddress gitlab_com_thorchain_thornode_v3_common.Address `protobuf:"bytes,2,opt,name=withdraw_address,json=withdrawAddress,proto3,casttype=github.com/decaswap-labs/decanode/common.Address" json:"withdraw_address,omitempty"`
	...
	WithdrawalAsset gitlab_com_thorchain_thornode_v3_common.Asset   `protobuf:"bytes,5,opt,name=withdrawal_asset,json=withdrawalAsset,proto3,customtype=github.com/decaswap-labs/decanode/common.Asset" json:"withdrawal_asset"`
