...
type MsgUnBond struct {
	...
	BondAddress         gitlab_com_thorchain_thornode_v3_common.Address `protobuf:"bytes,5,opt,name=bond_address,json=bondAddress,proto3,casttype=github.com/decaswap-labs/decanode/common.Address" json:"bond_address,omitempty"`
