...
type ObservedNetworkFeeVoter struct {
	...
	Chain             gitlab_com_thorchain_thornode_v3_common.Chain `protobuf:"bytes,3,opt,name=chain,proto3,casttype=github.com/decaswap-labs/decanode/common.Chain" json:"chain,omitempty"`
