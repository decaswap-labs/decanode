...
type MsgTssPool struct {
	...
	PoolPubKeyEddsa      gitlab_com_thorchain_thornode_v3_common.PubKey `protobuf:"bytes,12,opt,name=pool_pub_key_eddsa,json=poolPubKeyEddsa,proto3,casttype=github.com/decaswap-labs/decanode/common.PubKey" json:"pool_pub_key_eddsa,omitempty"`
