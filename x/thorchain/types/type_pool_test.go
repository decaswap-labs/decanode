...
func (PoolTestSuite) TestPool(c *C) {
	...
	m := NewMsgSwap(tx, common.ETHAsset, ethAddress, cosmos.NewUint(2), common.NoAddress, cosmos.ZeroUint(), "", "", nil, SwapType_market, 0, 0, SwapVersion_v1, signer)
	...
	msgSwap := NewMsgSwap(GetRandomTx(), common.ETHAsset, GetRandomETHAddress(), cosmos.NewUint(1000), common.NoAddress, cosmos.ZeroUint(), "", "", nil, SwapType_market, 0, 0, SwapVersion_v1, GetRandomBech32Addr())
