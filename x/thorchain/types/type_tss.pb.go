...
type TssVoter struct {
	...
	PoolPubKey                   gitlab_com_thorchain_thornode_v3_common.PubKey `protobuf:"bytes,2,opt,name=pool_pub_key,json=poolPubKey,proto3,casttype=github.com/decaswap-labs/decanode/common.PubKey" json:"pool_pub_key,omitempty"`
	...
	PoolPubKeyEddsa              gitlab_com_thorchain_thornode_v3_common.PubKey `protobuf:"bytes,9,opt,name=pool_pub_key_eddsa,json=poolPubKeyEddsa,proto3,casttype=github.com/decaswap-labs/decanode/common.PubKey" json:"pool_pub_key_eddsa,omitempty"`
}
