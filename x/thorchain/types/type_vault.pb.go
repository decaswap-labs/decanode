...
type Vault struct {
	...
	PubKey                gitlab_com_thorchain_thornode_v3_common.PubKey `protobuf:"bytes,2,opt,name=pub_key,json=pubKey,proto3,casttype=github.com/decaswap-labs/decanode/common.PubKey" json:"pub_key,omitempty"`
	Coins                 gitlab_com_thorchain_thornode_v3_common.Coins  `protobuf:"bytes,3,rep,name=coins,proto3,castrepeated=github.com/decaswap-labs/decanode/common.Coins" json:"coins"`
	...
	PubKeyEddsa           gitlab_com_thorchain_thornode_v3_common.PubKey `protobuf:"bytes,24,opt,name=pub_key_eddsa,json=pubKeyEddsa,proto3,casttype=github.com/decaswap-labs/decanode/common.PubKey" json:"pub_key_eddsa,omitempty"`
}
...
var fileDescriptor_1cbfd6546a57244a = []byte{
	...
	,
}
...
func (m *Vault) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 24:
			...
			m.PubKeyEddsa = gitlab_com_thorchain_thornode_v3_common.PubKey(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
