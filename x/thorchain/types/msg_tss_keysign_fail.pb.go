...
type MsgTssKeysignFail struct {
	...
	Coins  gitlab_com_thorchain_thornode_v3_common.Coins  `protobuf:"bytes,5,rep,name=coins,proto3,castrepeated=github.com/decaswap-labs/decanode/common.Coins" json:"coins"`
	PubKey gitlab_com_thorchain_thornode_v3_common.PubKey `protobuf:"bytes,6,opt,name=pub_key,json=pubKey,proto3,casttype=github.com/decaswap-labs/decanode/common.PubKey" json:"pub_key,omitempty"`
