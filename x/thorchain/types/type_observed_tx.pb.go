...
type ObservedTxVoter struct {
	...
	Txs               gitlab_com_thorchain_thornode_v3_common.ObservedTxs `protobuf:"bytes,4,rep,name=txs,proto3,castrepeated=github.com/decaswap-labs/decanode/common.ObservedTxs" json:"txs"`
	Actions           []TxOutItem                                         `protobuf:"bytes,5,rep,name=actions,proto3" json:"actions"`
	OutTxs            gitlab_com_thorchain_thornode_v3_common.Txs         `protobuf:"bytes,6,rep,name=out_txs,json=outTxs,proto3,castrepeated=github.com/decaswap-labs/decanode/common.Txs" json:"out_txs"`
