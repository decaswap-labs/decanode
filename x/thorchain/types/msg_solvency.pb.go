...
type MsgSolvency struct {
	Id     gitlab_com_thorchain_thornode_v3_common.TxID   `protobuf:"bytes,1,opt,name=id,proto3,casttype=github.com/decaswap-labs/decanode/common.TxID" json:"id,omitempty"`
	...
	PubKey gitlab_com_thorchain_thornode_v3_common.PubKey `protobuf:"bytes,3,opt,name=pub_key,json=pubKey,proto3,casttype=github.com/decaswap-labs/decanode/common.PubKey" json:"pub_key,omitempty"`
	Coins  gitlab_com_thorchain_thornode_v3_common.Coins  `protobuf:"bytes,4,rep,name=coins,proto3,castrepeated=github.com/decaswap-labs/decanode/common.Coins" json:"coins"`
