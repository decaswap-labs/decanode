...
type THORNameAlias struct {
	Chain   gitlab_com_thorchain_thornode_v3_common.Chain   `protobuf:"bytes,1,opt,name=chain,proto3,casttype=github.com/decaswap-labs/decanode/common.Chain" json:"chain,omitempty"`
	Address gitlab_com_thorchain_thornode_v3_common.Address `protobuf:"bytes,2,opt,name=address,proto3,casttype=github.com/decaswap-labs/decanode/common.Address" json:"address,omitempty"`
}
...
type THORName struct {
	...
	PreferredAsset                      gitlab_com_thorchain_thornode_v3_common.Asset `protobuf:"bytes,4,opt,name=preferred_asset,json=preferredAsset,proto3,customtype=github.com/decaswap-labs/decanode/common.Asset" json:"preferred_asset"`
...
var fileDescriptor_7fc089c417300976 = []byte{
	...
	,
}
