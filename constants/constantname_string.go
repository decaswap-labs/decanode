...
func _() {
	...
	_ = x[ArtificialRagnarokBlockHeight-157]
	_ = x[BondLockupPeriod-158]
	_ = x[BurnSynths-159]
	...
	_ = x[MemolessTxnTTL-167]
	_ = x[MemolessTxnRefCount-168]
	_ = x[MemolessTxnCost-169]
	_ = x[MemolessTxnMaxUse-170]
	_ = x[StrictBondLiquidityRatio-171]
	_ = x[SwapOutDexAggregationDisabled-172]
